...
status_label = Label(root, text="Image 1 of " + str(len(my_images)), bd=3, relief=SUNKEN, anchor=E)
...
def foward_click(image_number):
    ...
    status_label = Label(root, text="Image " + str(image_number) + " of " + str(len(my_images)), bd=3, relief=SUNKEN, anchor=E)
    status_label.grid(row=2, column=0, columnspan=3, sticky=W+E)
...
backward_button = Button(root, text="<<", command=lambda: back_click(1), state=DISABLED)
